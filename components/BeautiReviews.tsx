...
const BeautiReviews: React.FC<Props> = ({ reviews }) => {
  ...
  return (
    <section>
      ...
      <Swiper
        className="xl:max-w-[1200px] h-full reviewSwiper"
      ...
      >
        {reviews.map((review: Review, index: number) => (
          <SwiperSlide key={index} className="slideHandle w-full min-h-[380px]">
            <div className="slideContainer h-[200px] p-[20px] w-[70%] lg:w-[85%] border-[#C7CBD6] border-2 text-center flex flex-col gap-[13px] justify-center place-items-center">
